...
public interface PrintingRepository extends JpaRepository<Printing, Long> {
     ...
     * card + set + version
     */
    Optional<Printing> findByCard_IdAndCardSet_IdAndVersionNumber(
            Long cardId,
            Long cardSetId,
    ...
    /*
     * Queries by rarity are NOT unique
     */
    List<Printing> findByCard_IdAndCardSet_NameIgnoreCaseAndRarityIgnoreCase(
            Long cardId,
            String setName,
            String rarity
    );
    ...
    List<Printing> findByCard_IdAndCardSet_CodeIgnoreCaseAndRarityIgnoreCase(
            Long cardId,
            String setCode,
            String rarity
    );
    ...
    List<Printing> findByCard_IdAndCardSet_NameIgnoreCase(
            Long cardId,
            String setName
    );


    List<Printing> findByCard_IdAndCardSet_CodeIgnoreCase(
            Long cardId,
            String setCode
    );
    ...
    @Query(value = """
            ...
            WHERE cs.game = :game
            AND (:cardName IS NULL OR :cardName = '' 
                 OR c.name ILIKE CONCAT('%', :cardName, '%'))
            AND (:setCode IS NULL OR :setCode = '' 
                 OR cs.code = :setCode)
